...
public:
  ...
  struct Class final {
     ...
     * \return 返回实例指针数组
     */
    template <typename T> auto FindObjectsByType() -> std::vector<T> {
    ...
    template <typename T> auto New() -> T * {
      if (mode_ == Mode::Il2Cpp)
  ...
  struct Field final {
    ...
    template <typename T> auto SetValue(T *value) const -> void {
      if (!static_field)
        return;
      if (mode_ == Mode::Il2Cpp)
    ...
    template <typename T> auto GetValue(T *value) const -> void {
      if (!static_field)
        return;
      if (mode_ == Mode::Il2Cpp)
...
public:
  ...
  public:
    ...
    template <typename Type> struct List : Object {
      Array<Type> *pList;
      int size{};
      int version{};
      void *syncRoot{};
    ...
    template <typename TKey, typename TValue> struct Dictionary : Object {
      struct Entry {
        int iHashCode;
        int iNext;
        TKey tKey;
    ...
    struct Component : UnityObject {
      ...
      template <typename T> auto GetComponentsInChildren() -> Array<T> * {
        static Method *method;
        if (!method)
          method = Get("UnityEngine.CoreModule.dll")
                       ->Get("Component")
      ...
      template <typename T> auto GetComponents() -> Array<T> * {
        static Method *method;
        if (!method)
          method = Get("UnityEngine.CoreModule.dll")
                       ->Get("Component")
      ...
      template <typename T> auto GetComponents(Class *pClass) -> Array<T> * {
        static Method *method;
        if (!method)
          method = Get("UnityEngine.CoreModule.dll")
                       ->Get("Component")
      ...
      template <typename T> auto GetComponentsInParent() -> Array<T> * {
        static Method *method;
        if (!method)
          method = Get("UnityEngine.CoreModule.dll")
                       ->Get("Component")
      ...
      template <typename T> auto GetComponentInChildren(Class *pClass) -> T {
        static Method *method;
        if (!method)
          method = Get("UnityEngine.CoreModule.dll")
                       ->Get("Component")
      ...
      template <typename T> auto GetComponentInParent(Class *pClass) -> T {
        static Method *method;
        if (!method)
          method = Get("UnityEngine.CoreModule.dll")
                       ->Get("Component")
    ...
    struct GameObject : UnityObject {
      ...
      template <typename T> auto GetComponent(const Class *type) -> T {
        static Method *method;
        if (!method)
          method = Get("UnityEngine.CoreModule.dll")
                       ->Get("GameObject")
      ...
      template <typename T> auto GetComponentInParent(const Class *type) -> T {
        static Method *method;
        if (!method)
          method = Get("UnityEngine.CoreModule.dll")
                       ->Get("GameObject")
